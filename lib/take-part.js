...
async function fetchGroup(citySlug, formatting, options) {
  const { cities } = await fetchAPI(
    `
    query GroupBySlug {
...
async function fetchCountry(countrySlug, formatting, options) {
  const { countries } = await fetchAPI(
    `
    query CountryBySlug {
...
async function fetchFederalCountry(countrySlug, formatting, options) {
