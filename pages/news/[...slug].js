...
export async function getStaticProps({ locale, params: { slug } }) {
  ...
  if (data === null) {
    logger.error({
      message: "404", locale, path: `${locale}/news/[${slug}]`
    });
  ...
  logger.info({
    message: "timing", locale, path: `${locale}/news/[${slug}]`, time: getElapsed.seconds()
  });

  return {
    revalidate: 60 * 5, props: {
      ...data, ...globalData, initialState
    }
  };
}
