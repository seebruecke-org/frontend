...
export default function SectionNavigation({ items, className }) {
  ...
  return (
    ...
    >
      ...
      <nav className="py-6 sm:py-7 md:py-8 px-10 md:px-0 col-span-full md:col-start-3 md:col-span-10 flex flex-row space-x-3 md:space-x-5 flex-nowrap overflow-x-auto w-full -ml-3">
