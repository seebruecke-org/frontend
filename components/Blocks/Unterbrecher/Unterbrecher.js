  ...
  return (
    ...
    >
      <div
        ...
        } flex flex-col justify-center md:min-h-full w-auto md:w-2/4 px-8 md:px-16 py-16 md:py-32 mx-8 md:mx-0 ${
          !hasPaddingBottom && reversed && media && '-mt-36'
        } ${!hasPaddingTop && !reversed && media && '-mb-36'} md:mt-0 z-10`}
      >
